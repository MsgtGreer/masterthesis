...
\documentclass[ngerman, USenglish, UKenglish]{scrbook}
%-------------------------------------------------------------------------------
...
\newcommand*{\guideversion}{6.0}
\newcommand*{\texlive}{2016}
\usepackage{ifthen}

% Adjustments to biblatex output are in ubonn-biblatex style file
% Note that testall.py looks for biblatex=false string
% Compilation probably fails for TeX Live < 2011.
%   Needs at least todonotes installed by hand and scrlayer-scrpage switched to scrpage2.
\ifthenelse{\texlive < 2011} {% Probably will not work - 
  \usepackage[shownotes, cleveref, biblatex=false, txfonts, feynmp]{../ubonn-thesis}
}{%
  \usepackage[shownotes, cleveref, bibstyle=alphabetic, feynmp]{../ubonn-thesis}
...
\newcommand{\thesistitle}{pA-meters redesign}
...
\newcommand*{\thesissubmit}{31.04.2019}
...
\newcommand{\thesisabstract}{%
  \begin{otherlanguage}{UKenglish}
    ...
    The recommendations should also be valid for any other department in
    the Faculty of Mathematics and Natural Sciences.
    The guide contains examples and recommendations on what packages to use
    and how to use them.
    Title pages for PhD, Diplom, Master and Bachelor
    theses are included.
    It makes no attempt to be an introduction to \LaTeX.
    Indeed some basic \LaTeX{} knowledge is assumed.
    While the guide is primarily geared to (particle) physics theses,
    it should also be useful for others.
  \end{otherlanguage}
}
...
\ifthenelse{\texlive > 2010} {%
  ...
  {\raggedright
    ...
    \bibliography{./guide_refs.bib,%
      refs/zeus_2009,%
      refs/zeus_2010,%
      ../refs/standard_refs-bibtex,./refs/example_refs-ascii} % chktex 26
  }
}
